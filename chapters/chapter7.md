...
اما اگر بازنویسی کنیم، ممکن است پنج سال دیگر هم دوام بیاوریم!"

یکی دیگر از داستان‌های رایج این است: 
"ما نمی‌توانیم آنقدر سریع توسعه دهیم تا با نیازهای مدرن کاربران همراه شویم." 
...
اگر شما سعی کنید ،برای مثال، پروتکلی اختراع کنید درحالی‌که یک پروتکل کاملاً خوب برای نیازتان وجود دارد، زمان زیادی را صرف کار روی پروتکل خواهید کرد، درحالی‌که می‌توانستید روی نرم‌افزار خود کار کنید. 
